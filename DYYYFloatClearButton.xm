...
static NSString *const kDYYYClearButtonStickToEdgeKey = @"DYYYClearButtonStickToEdge";
...
- (BOOL)dyyyStickToEdgeEnabled {
    return [[NSUserDefaults standardUserDefaults] boolForKey:kDYYYClearButtonStickToEdgeKey];
}
